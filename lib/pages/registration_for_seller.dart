...
import 'registration_for_seller_2.dart';
class RegistrationForSeller extends StatelessWidget{
  @override
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        ...
                        child: new TextFormField(
                          ...
                          cursorColor: Colors.white,
                          decoration: new InputDecoration(labelText: "Отчество",fillColor: Color.fromARGB(
                              255, 196, 196, 196), filled: true,
                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0),
                                  borderSide: BorderSide(
                                      width: 0,
                      ...
                      new Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => RegistrationForSeller2()),
                          );},
                          child: Text("Далее", style: TextStyle(fontFamily: 'segoeui', fontSize: 20),),
                        ),
                      ),
                    ]
                )
